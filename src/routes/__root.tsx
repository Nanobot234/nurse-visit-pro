  ...
  head: () => ({
    meta: [
      ...
      { title: "JARME Nursing Visit Notes" },
      {
        name: "description",
        content:
          "Electronic nursing visit notes for JARME Home & Healthcare Services, signed on the spot by the nurse and the aide.",
      },
      { property: "og:title", content: "JARME Nursing Visit Notes" },
      {
        property: "og:description",
        content: "Complete, sign and file home care nursing visit notes electronically.",
      },
